import { Component, ComponentFactoryResolver, Directive, ElementRef, EventEmitter, HostListener, Inject, Injectable, Input, IterableDiffers, NgModule, Output, Renderer, ViewContainerRef, forwardRef } from '@angular/core';
...
var DATEPICKER_VALUE_ACCESSOR = {
    ...
    useExisting: forwardRef(function () { return FsDatepickerDirective; }),
    multi: true
};
...
var FsDatepickerDialogComponent = (function () {
     ...
     */
    function () {
        var /** @type {?} */ m = moment([this.parentInstance.selected.year, this.parentInstance.selected.month - 1, this.parentInstance.selected.day]);
    ...
    FsDatepickerDialogComponent.propDecorators = {
        "documentKeydown": [{ type: HostListener, args: ['document:keydown', ['$event'],] },],
    };
...
var FsDatepickerDirective = (function () {
    ...
    FsDatepickerDirective.propDecorators = {
        "hasCalendar": [{ type: Input, args: ['hasCalendar',] },],
        "hasDate": [{ type: Input, args: ['hasDate',] },],
        "minYear": [{ type: Input, args: ['minYear',] },],
        "maxYear": [{ type: Input, args: ['maxYear',] },],
        "hasTime": [{ type: Input, args: ['hasTime',] },],
        "view": [{ type: Input, args: ['view',] },],
        "disabledDays": [{ type: Input, args: ['disabledDays',] },],
        "disabledMinutes": [{ type: Input },],
        "disabledHours": [{ type: Input },],
        "disabledTimes": [{ type: Input },],
...
var FsIsscrollDirective = (function () {
    ...
    FsIsscrollDirective.propDecorators = {
        "fsOptions": [{ type: Input, args: ['fsOptions',] },],
        "fsInstance": [{ type: Input, args: ['fsInstance',] },],
    };
